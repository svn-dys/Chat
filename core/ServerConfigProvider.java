 ...
 * the clients/{@link ui.UINetworkThread}UI-Network-Thread know of the server configuration
 * and can use it to connect to the server through its associated UI network sockets.
*/
